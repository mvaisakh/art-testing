...
public class ShifterOperand {
  ...
  public static void main(String[] args) {
    ...
    start = System.currentTimeMillis(); timeIntSingleUseLatency1(5000); end = System.currentTimeMillis();
    if (!verifyIntSingleUseLatency1()) { rc++; }
    System.out.println(prefix + "IntSingleUseLatency1: " + (end - start));
    start = System.currentTimeMillis(); timeIntSingleUseLatency1Thread2(3000); end = System.currentTimeMillis();
    if (!verifyIntSingleUseLatency1Thread2()) { rc++; }
    System.out.println(prefix + "IntSingleUseLatency1Thread2: " + (end - start));
    start = System.currentTimeMillis(); timeIntSingleUseLatency1Thread3(2000); end = System.currentTimeMillis();
    if (!verifyIntSingleUseLatency1Thread3()) { rc++; }
    System.out.println(prefix + "IntSingleUseLatency1Thread3: " + (end - start));
    start = System.currentTimeMillis(); timeIntSingleUseLatency1Thread4(1500); end = System.currentTimeMillis();
    if (!verifyIntSingleUseLatency1Thread4()) { rc++; }
    System.out.println(prefix + "IntSingleUseLatency1Thread4: " + (end - start));
    start = System.currentTimeMillis(); timeIntSingleUseLatency2(4000); end = System.currentTimeMillis();
    if (!verifyIntSingleUseLatency2()) { rc++; }
    System.out.println(prefix + "IntSingleUseLatency2: " + (end - start));
    start = System.currentTimeMillis(); timeIntSingleUseLatency3(5000); end = System.currentTimeMillis();
    if (!verifyIntSingleUseLatency3()) { rc++; }
    System.out.println(prefix + "IntSingleUseLatency3: " + (end - start));
    start = System.currentTimeMillis(); timeIntSingleUseLatencyLoop(7000); end = System.currentTimeMillis();
    ...
    // above.
    start = System.currentTimeMillis(); timeLongSingleUseLatency1(5000); end = System.currentTimeMillis();
    if (!verifyLongSingleUseLatency1()) { rc++; }
    System.out.println(prefix + "LongSingleUseLatency1: " + (end - start));
    start = System.currentTimeMillis(); timeLongSingleUseLatency1Thread2(3000); end = System.currentTimeMillis();
    if (!verifyLongSingleUseLatency1Thread2()) { rc++; }
    System.out.println(prefix + "LongSingleUseLatency1Thread2: " + (end - start));
    start = System.currentTimeMillis(); timeLongSingleUseLatency1Thread3(2000); end = System.currentTimeMillis();
    if (!verifyLongSingleUseLatency1Thread3()) { rc++; }
    System.out.println(prefix + "LongSingleUseLatency1Thread3: " + (end - start));
    start = System.currentTimeMillis(); timeLongSingleUseLatency1Thread4(1500); end = System.currentTimeMillis();
    if (!verifyLongSingleUseLatency1Thread4()) { rc++; }
    System.out.println(prefix + "LongSingleUseLatency1Thread4: " + (end - start));
    start = System.currentTimeMillis(); timeLongSingleUseLatency2(4000); end = System.currentTimeMillis();
    if (!verifyLongSingleUseLatency2()) { rc++; }
    System.out.println(prefix + "LongSingleUseLatency2: " + (end - start));
    start = System.currentTimeMillis(); timeLongSingleUseLatency3(5000); end = System.currentTimeMillis();
    if (!verifyLongSingleUseLatency3()) { rc++; }
    System.out.println(prefix + "LongSingleUseLatency3: " + (end - start));
    start = System.currentTimeMillis(); timeLongSingleUseLatencyLoop(3000); end = System.currentTimeMillis();
    if (!verifyLongSingleUseLatencyLoop()) { rc++; }
    System.out.println(prefix + "LongSingleUseLatencyLoop: " + (end - start));


    start = System.currentTimeMillis(); timeMultipleUsesDifferentPathInt(5000); end = System.currentTimeMillis();
    if (!verifyMultipleUsesDifferentPathInt()) { rc++; }
    System.out.println(prefix + "MultipleUsesDifferentPathInt: " + (end - start));
    start = System.currentTimeMillis(); timeMultipleSuccessiveUsesSamePathInt(3500); end = System.currentTimeMillis();
    if (!verifyMultipleSuccessiveUsesSamePathInt()) { rc++; }
    System.out.println(prefix + "MultipleSuccessiveUsesSamePathInt: " + (end - start));
    start = System.currentTimeMillis(); timeMultipleSeparatedUsesSamePathInt(4000); end = System.currentTimeMillis();
    if (!verifyMultipleSeparatedUsesSamePathInt()) { rc++; }
    System.out.println(prefix + "MultipleSeparatedUsesSamePathInt: " + (end - start));

    // The `long` versions use the same iteration counts as the `int` versions
    // above.
    start = System.currentTimeMillis(); timeMultipleUsesDifferentPathLong(1500); end = System.currentTimeMillis();
    if (!verifyMultipleUsesDifferentPathLong()) { rc++; }
    System.out.println(prefix + "MultipleUsesDifferentPathLong: " + (end - start));
    start = System.currentTimeMillis(); timeMultipleSuccessiveUsesSamePathLong(3500); end = System.currentTimeMillis();
    if (!verifyMultipleSuccessiveUsesSamePathLong()) { rc++; }
    System.out.println(prefix + "MultipleSuccessiveUsesSamePathLong: " + (end - start));
    start = System.currentTimeMillis(); timeMultipleSeparatedUsesSamePathLong(4000); end = System.currentTimeMillis();
